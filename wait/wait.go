...
//	"time"
//
//	"github.com/asiainfoLDP/datafoundry_oauth2/util/runtime"
//)
//
//// For any test of the style:
////   ...
////   <- time.After(timeout):
////      test.Errorf("Timed out")
//// The value for timeout should effectively be "forever." Obviously we don'test want our tests to truly lock up forever, but 30s
...
//				select {
//				case <-tick.C:
//					// If the consumer isn'test ready for this signal drop it and
